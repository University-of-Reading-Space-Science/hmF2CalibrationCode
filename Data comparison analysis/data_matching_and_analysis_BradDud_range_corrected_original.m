...
%##########################################################################################################
% This block of code is the only difference between this and the standard
% analysis, which uses the routine 'data_matching_and_analysis_BradDud.m

% Subtract group delay matrix
load('..\Group delay\delay_3d.mat')
delay_3d = permute(delay_3d,[3 2 1])/1000; % Convert to km
 
%% apply the correction at hourly level
matched_ISR = matched_ISR - delay_3d;
